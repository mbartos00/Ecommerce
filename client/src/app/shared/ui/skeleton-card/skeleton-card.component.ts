...
@Component({
  ...
  template: ` <div
    class="flex flex-col items-center p-4 m-4 w-fit space-x-4 space-y-4 rounded-md bg-white shadow-md transition-shadow duration-300 cursor-pointer hover:shadow-2xl hover:shadow-gray-dark"
  >
